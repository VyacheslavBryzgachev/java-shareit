...
public class BookingClient extends BaseClient {
    ...
    public ResponseEntity<Object> getUserItemsBookings(long userId, String state, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "state", state,
                "from", from,
                "size", size
    ...
    public ResponseEntity<Object> updateBooking(long bookingId, boolean isApproved, long userId) {
